...
with open('/home/x/newww.csv') as csv_file:
...
for website in websites:
    ...
    try:
        internalLinks, externalLinks, headers = execute(website)
    except:
        flag = False
        internal_urls.clear()
        external_urls.clear()
    ...
    if flag == True:
        for link in internalLinks:
            try:
                ...
                page = urlopen(reqq, timeout=10).read()
